...
<body class="flex items-center justify-center min-h-screen p-6">
    <div class="bg-white cartoon-border cartoon-shadow p-12 flex flex-col items-center gap-8 text-center w-full max-w-[480px]">
        ...
        <div class="w-full space-y-4">
            ...
            <a href="{{ route('home') }}" class="w-full bg-slate-900 text-white py-5 rounded-2xl font-black text-xs tracking-widest uppercase italic block shadow-[4px_4px_0px_0px_#000] hover:translate-y-1 transition-all">
                KEMBALI KE BERANDA
            </a>
        </div>
    </div>
